...
eblit-src_unpack-post() {
	cd "${S}"
	epatch "${FILESDIR}"/2.10/glibc-2.10-make-382.patch

	einfo "Patching Glibc for CVE-2010-3847 and CVE-2010-3856"
	epatch "${FILESDIR}"/ignore_origin.patch
	epatch "${FILESDIR}"/dst-expansion-fix.patch
	epatch "${FILESDIR}"/require_suid_on_audit_objs.patch
